        ...
        return (
            <>
                <div className={style.wordTab}>
                    <div className={tabIndex === 0 ? style.wordTabItemSelect : style.wordTabItem}
                         onClick={() => setIndex(0, tabIndex)}>
                        <i className='iconfont iconai-article'></i>
                        <span>文章</span>
                    </div>
                    <div className={tabIndex === 1 ? style.wordTabItemSelect : style.wordTabItem}
                         onClick={() => setIndex(1, tabIndex)}>
                        <i className='iconfont iconnews'></i>
                        <span>动态</span>
                    </div>
                    <div className={tabIndex === 2 ? style.wordTabItemSelect : style.wordTabItem}
                         onClick={() => setIndex(2, tabIndex)}>
                        <i className='iconfont iconpinglun1'></i>
                        <span>最新评论</span>
                    </div>
                    <div className={tabIndex === 3 ? style.wordTabItemSelect : style.wordTabItem}
                         onClick={() => setIndex(3, tabIndex)}>
                            ...
                            <div className={style.wordItem} onClick={() => this.goDetail(item.id)} key={item.id}>
                                <div className={style.wordItemLeft}>
                                    ...
                                    <i className='iconfont iconzuanshi'></i>
                                        ...
                                        {item.info.zsNum+parseFloat(Math.random().toFixed(1))}
                                      </span>
                                        <span>
